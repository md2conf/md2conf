...
public class View2MdConvertCommand implements Runnable{
    ...
    private View2MdConvertOptions view2MdConvertOptions;


    @Override
    public void run() {
        convertView2Md(this.view2MdConvertOptions);
    }

    public static void convertView2Md(View2MdConvertOptions view2MdConvertOptions) {
        ConfluenceContentModel model = ModelFilesystemUtil.readModel(view2MdConvertOptions.modelPath);
        View2MdConverter view2MdConverter = new View2MdConverter(view2MdConvertOptions.outputDirectory, formatOptionsAsDataHolder(view2MdConvertOptions));
        view2MdConverter.convert(model);
        log.info("Converting to markdown result saved to {}", view2MdConvertOptions.outputDirectory);
    }

    private static DataHolder formatOptionsAsDataHolder(View2MdConvertOptions view2MdConvertOptions) {
