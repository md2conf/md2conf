...
class ModelReaderUtilTest {
    ...
    private static final String TEST_RESOURCES = "src/test/resources/io/github/md2conf/confluence/model";
    ...
    void test_read_confluence_content_zero_page() throws IOException {
        ...
        Assertions.assertNotNull(confluenceContent);
        Assertions.assertTrue(confluenceContent.getPages().isEmpty());
    }
    ...
    void test_read_confluence_content_confluence_content_non_model_fields() throws IOException {
        ...
        ConfluenceContent confluenceContent =  ModelReaderUtil.readFromYamlOrJson(file);
        Assertions.assertNotNull(confluenceContent);
        Assertions.assertFalse(confluenceContent.getPages().isEmpty());
    }
