...
public class DumpMojoPluginIT extends AbstractMd2ConfMojoIT {
    ...
    void dump() {
        ...
        // assert
        assertThat(outputPath.resolve("65552.xhtml")).isRegularFile();
        assertThat(outputPath.resolve("confluence-content-model.json")).isRegularFile();
    }
